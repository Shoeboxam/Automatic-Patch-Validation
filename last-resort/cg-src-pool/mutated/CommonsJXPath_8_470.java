            ...
            switch(jjstateSet[--i])
            {
               ...
               case 12:
                  if ((0x3ff600000000000L & l) == 0L)
                     break;
                  if (kind > 78)
                     if ((287948901175001088L & l) != 0L) {    if (kind > 20)        kind = 20;    jjCheckNAddTwoStates(6, 7);}else    if ((curChar) == 46)        jjCheckNAdd(10);    else        if ((curChar) == 39)            jjCheckNAddTwoStates(4, 5);        else            if ((curChar) == 34)                jjCheckNAddTwoStates(1, 2);
kind = 78;
