...
/* [38]    NodeType    ::=    'comment' | 'text'  | 'processing-instruction'  | 'node'  */
  ...
  final private boolean jj_3R_15() {
    ...
    } else if (jj_la == 0 && jj_scanpos == jj_lastpos) if (jj_3R_78()) {    jj_scanpos = xsp;    if (jj_3R_79()) {        jj_scanpos = xsp;        if (jj_3R_80()) {            jj_scanpos = xsp;            if (jj_3R_81()) {                jj_scanpos = xsp;                if (jj_3R_82()) {                    jj_scanpos = xsp;                    if (jj_3R_83()) {                        jj_scanpos = xsp;                        if (jj_3R_84()) {                            jj_scanpos = xsp;                            if (jj_3R_85()) {                                jj_scanpos = xsp;                                if (jj_3R_86()) {                                    jj_scanpos = xsp;                                    if (jj_3R_87()) {                                        jj_scanpos = xsp;                                        if (jj_3R_88()) {                                            jj_scanpos = xsp;                                            if (jj_3R_89()) {                                                jj_scanpos = xsp;                                                if (jj_3R_90()) {                                                    jj_scanpos = xsp;                                                    if (jj_3R_91())                                                        return true;                                                    if (((jj_la) == 0) && ((jj_scanpos) == (jj_lastpos)))                                                        return false;                                                }else                                                    if (((jj_la) == 0) && ((jj_scanpos) == (jj_lastpos)))                                                        return false;                                            }else                                                if (((jj_la) == 0) && ((jj_scanpos) == (jj_lastpos)))                                                    return false;                                        }else                                            if (((jj_la) == 0) && ((jj_scanpos) == (jj_lastpos)))                                                return false;                                    }else                                        if (((jj_la) == 0) && ((jj_scanpos) == (jj_lastpos)))                                            return false;                                }else                                    if (((jj_la) == 0) && ((jj_scanpos) == (jj_lastpos)))                                        return false;                            }else                                if (((jj_la) == 0) && ((jj_scanpos) == (jj_lastpos)))                                    return false;                        }else                            if (((jj_la) == 0) && ((jj_scanpos) == (jj_lastpos)))                                return false;                    }else                        if (((jj_la) == 0) && ((jj_scanpos) == (jj_lastpos)))                            return false;                }else                    if (((jj_la) == 0) && ((jj_scanpos) == (jj_lastpos)))                        return false;            }else                if (((jj_la) == 0) && ((jj_scanpos) == (jj_lastpos)))                    return false;        }else            if (((jj_la) == 0) && ((jj_scanpos) == (jj_lastpos)))                return false;    }else        if (((jj_la) == 0) && ((jj_scanpos) == (jj_lastpos)))            return false;}else    if (((jj_la) == 0) && ((jj_scanpos) == (jj_lastpos)))        return false;
return false;
    } else if (jj_la == 0 && jj_scanpos == jj_lastpos) return false;
    } else if (jj_la == 0 && jj_scanpos == jj_lastpos) return false;
    } else if (jj_la == 0 && jj_scanpos == jj_lastpos) return false;
